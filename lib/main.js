...
const { cleanupLegacyRegistry } = require("./endpoint");
const { ClientRegistrar } = require("./register-clients");
...
module.exports = {
  ...
  activate() {
    ...
    this.clientRegistrar = new ClientRegistrar({
    ...
    this.subscriptions.add(
      lumine.commands.add("lumine-workspace", {
        "lumine-mcp:toggle-tools": {
          ...
          didDispatch: () => this.toggleToolsView.toggle(),
        },
        "lumine-mcp:start": {
        ...
        "lumine-mcp:register-to-claude": {
          ...
          didDispatch: () => this.clientRegistrar.register("claude"),
        },
        "lumine-mcp:register-to-codex": {
          description: "Register this package as a global Codex MCP server.",
          didDispatch: () => this.clientRegistrar.register("codex"),
        },
      }),
    );
