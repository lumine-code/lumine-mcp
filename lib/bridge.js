 ...
 * Runs inside Lumine and provides direct access to atom APIs
 */
...
function isToolEnabled(toolName) {
  const mode = atom.config.get("lumine-mcp.listMode") || "blacklist";
  const list = atom.config.get("lumine-mcp.toolList") || [];
  if (mode === "greenlist") {
